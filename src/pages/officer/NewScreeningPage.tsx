    ...
    <div className="space-y-4 pb-16 animate-fade-in">
      ...
      <div className="px-1 pt-1 pb-2">
        <div className="flex items-center justify-between mb-1.5">
          <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-cyan-400">Step {step} of 3</span>
          <span className="text-[11px] font-semibold text-slate-300">
            {step === 1 && 'Field context'}
            {step === 2 && 'Sensor reading'}
            {step === 3 && 'Evidence seal'}
          </span>
        </div>
        <div className="h-1 bg-slate-800 rounded-full overflow-hidden">
          <div className="h-full bg-cyan-400 rounded-full transition-all" style={{ width: `${(step / 3) * 100}%` }} />
        </div>
      </div>
      ...
      {step === 1 && (
        <div className="space-y-3.5 animate-fade-in">
          <div className="space-y-5">
            {/* GPS is the source of truth; district selection is secondary. */}
            <section className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={() => { triggerHapticTap(); refreshLocation(selectedCity); }}
                  className="p-1.5 rounded-lg text-cyan-400 hover:bg-slate-800"
                  title="Refresh GPS"
                >
              ...
              <div className="flex items-center justify-between gap-3 py-2.5">
                <div className="min-w-0">
                  <div className="text-[10px] font-mono uppercase tracking-wider text-slate-500">GPS fix</div>
            ...
            <section className="space-y-2">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-[10px] font-mono uppercase tracking-wider text-slate-500">Detected district</div>
                  <div className="text-sm font-semibold text-white mt-0.5">{selectedCity}, Tamil Nadu</div>
                </div>
                <button
                  type="button"
                  onClick={() => { triggerHapticTap(); setShowCityPicker(!showCityPicker); }}
                  className="px-3 py-1.5 rounded-lg text-[10px] font-mono font-bold text-cyan-300 bg-slate-900 hover:bg-slate-800"
                >
                ...
                <div className="grid grid-cols-2 gap-1.5 pt-1">
                  {['Coimbatore', 'Chennai', 'Madurai', 'Salem', 'Tiruchirappalli', 'Erode'].map((city) => (
                    <button
                      ...
                      className={`py-2 px-2 rounded-lg text-xs font-mono text-left transition-all ${
                        selectedCity === city
                          ? 'bg-cyan-500 text-tactical-950 font-bold'
            ...
            <section className="space-y-2">
              <label className="text-[10px] font-mono uppercase tracking-wider text-slate-500 block">
                Subject reference · anonymized
              </label>
              <input
                type="text"
                value={subjectRef}
                onChange={(e) => setSubjectRef(e.target.value)}
                className="w-full bg-slate-900/80 rounded-lg px-3 py-2.5 text-xs font-mono text-white focus:outline-none focus:ring-1 focus:ring-cyan-500"
              />
            </section>
          </div>
      ...
      {step === 2 && (
        <div className="space-y-4 animate-fade-in">
          <div className="bg-tactical-900/60 rounded-2xl p-4 space-y-4">
            ...
            <div className="bg-slate-950/60 rounded-xl p-4 text-center space-y-3">
      ...
      {step === 3 && (
        <div className="space-y-4 animate-fade-in">
          <div className="bg-tactical-900/60 rounded-2xl p-4 space-y-3.5">
            ...
            <div>
              ...
              <div className="flex space-x-2">
                <input
                  ...
                  className="flex-1 bg-slate-950/60 rounded-lg px-3 py-2 text-xs font-mono text-white"
                />
                <button
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-950/60 rounded-lg px-3 py-2 text-xs font-mono text-white"
              />
            </div>
