      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-slate-900/70 rounded-xl pl-9 pr-4 py-2.5 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-cyan-400"
          />
        </div>
      ...
      <div className="space-y-2.5">
        {filtered.map((sc) => (
          <div
            ...
            className="bg-slate-900/45 rounded-xl p-3.5 hover:bg-slate-900/65 space-y-2 cursor-pointer transition-all active:scale-[0.99]"
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
            ...
            <div className="grid grid-cols-3 gap-1.5 pt-1 text-[10px] font-mono">
              <div className="bg-slate-950/50 p-1.5 rounded text-slate-300 truncate">
        ...
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 bg-black/80 backdrop-blur-sm animate-fade-in">
          <div className="w-full max-w-lg bg-tactical-900 border-t sm:border border-slate-700 rounded-t-2xl sm:rounded-2xl max-h-[85vh] flex flex-col overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-5 space-y-4">
              ...
              <div className="bg-slate-950/50 rounded-xl p-3.5 space-y-2">
